...
#include "Characters/TargetNPCMovementSM.h"
#include "Characters/TargetNPCBehaviorSM.h"
	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Components
			{
				...
				TargetNPCMovementSM::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				TargetNPCBehaviorSM::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				Projectile::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			}
			...
			// start root.CharacterControl.Events
			{
				...
				Event_CreateProjectile::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_InitProjectilePool::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_CreateTargetNPC::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				SoldierNPCMovementSM_Event_SHOOTING_TARGET::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				SoldierNPCMovementSM_Event_TARGET_REACHED::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				SoldierNPCBehaviorSM_Event_ACQUIRE_TARGET::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				SoldierNPCMovementSM_Event_STOP::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				TargetNPCMovementSM_Event_MOVE_TO::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				TargetNPCMovementSM_Event_TARGET_REACHED::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				Event_TimeSynch_C_to_S::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_TimeSynch_S_to_C::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_MoveSoldier_C_to_S::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_SpawnProjectile_C_to_S::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_MoveSoldier_S_to_C::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_Ack_S_to_C::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_SoldierAcquireTarget_C_to_S::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				Event_SoldierAcquireTarget_S_to_C::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				...
				Event_NudgeSoldier_C_to_S::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			}
