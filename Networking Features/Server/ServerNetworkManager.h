...
struct ServerNetworkManager : public NetworkManager
{
	...
	void scheduleEventToAllExcept(PE::Networkable *pNetworkable, PE::Networkable *pNetworkableTarget, int exceptClient, bool shouldGaurantee = false);
	void scheduleGhostToAll(Ghost *pGhost);
	...
	static std::unordered_map<int, Ghost *> ghostMap;
